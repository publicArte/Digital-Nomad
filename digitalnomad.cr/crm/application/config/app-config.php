...
*
*/
define('APP_BASE_URL', 'http://digitalnomad.cr/crm/');
...
*/
define('APP_ENC_KEY', 'a45bf9bb784402739bcaf8f9a0b9162a');
 ...
 */
define('APP_DB_USERNAME', 'globalma_nomad');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'DigitalNomad2020');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'globalma_nomad');
